create table tb_movie (id bigint not null auto_increment, count integer, image varchar(255), score float(53), title varchar(255), primary key (id)) engine=MyISAM;
create table tb_score (score_value float(53), movie_id bigint not null, user_id bigint not null, primary key (movie_id, user_id)) engine=MyISAM;
create table tb_user (id bigint not null auto_increment, email varchar(255), primary key (id)) engine=MyISAM;
